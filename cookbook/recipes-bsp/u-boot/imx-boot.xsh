...
if os.environ["MACHINE"] in ("imx95-verdin-evk", "smarc-imx95", "verdin-imx95-a0"):
    ...
    cp @(_BUILD_PATH)/tmp/@(_MACHINE)/u-boot/u-boot.bin @(_BUILD_PATH)/tmp/@(_MACHINE)/imx-mkimage/iMX8M/u-boot.bin
    ...
    cp @(_BUILD_PATH)/tmp/@(_MACHINE)/u-boot/u-boot.bin @(_BUILD_PATH)/tmp/@(_MACHINE)/imx-mkimage/iMX93/u-boot.bin
    cp @(_BUILD_PATH)/tmp/@(_MACHINE)/u-boot/spl/u-boot-spl.bin @(_BUILD_PATH)/tmp/@(_MACHINE)/imx-mkimage/iMX93/u-boot-spl.bin
else:
    Error_Out(
